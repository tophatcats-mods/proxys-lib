...
/**
 * This ONLY exists to be able to create door blocks as Vanilla's
 * DoorBlock constructor has protected access.
...
public class BasicDoorBlock extends DoorBlock {
     ...
     */
    public BasicDoorBlock(final Properties properties) {
        super(properties);
    }
}
