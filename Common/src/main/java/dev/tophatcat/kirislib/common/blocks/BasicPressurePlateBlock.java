...
/**
 * This ONLY exists to be able to create Pressure Plate blocks as Vanilla's
 * PressurePlateBlock constructor has protected access.
 * I'd rather not Access Transform/Widen every time.
 */
public class BasicPressurePlateBlock extends PressurePlateBlock {

    /**
     * @param properties The blocks properties.
     */
    public BasicPressurePlateBlock(final Properties properties) {
